-- ============================================================
-- 감사일기 (Gratitude Diary) — Supabase schema
...
create table public.group_members (
  ...
  user_id     uuid references public.profiles(id) on delete cascade, -- null = 초대 대기중
...
create table public.comments (
  ...
  sticker     text,                 -- sticker name e.g. 'tux21' (null if text)
  created_at  timestamptz not null default now(),
...
-- ============================================================
-- STORAGE
-- Create a bucket 'photos' (private). Object path convention:
